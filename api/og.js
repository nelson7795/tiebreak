...
export default async function handler(req,res){
  try{
    ...
    const lines=wrap(d?.question,34);
    const q1=esc(lines[0]||'Which should I choose?');
    const q2=esc(lines[1]||'');

    const base=Buffer.from(`<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      <rect width="1200" height="630" fill="#0b0d17"/>
      <text x="60" y="58" font-family="DejaVu Sans, sans-serif" font-size="28" font-weight="700" letter-spacing="3" fill="#c4b5fd">TIEBREAK</text>
      <text x="60" y="122" font-family="DejaVu Sans, sans-serif" font-size="44" font-weight="700" fill="#ffffff">${q1}</text>
      ${q2?`<text x="60" y="172" font-family="DejaVu Sans, sans-serif" font-size="44" font-weight="700" fill="#ffffff">${q2}</text>`:''}
      <rect x="70" y="220" width="500" height="315" rx="22" fill="#ffffff"/>
      <rect x="630" y="220" width="500" height="315" rx="22" fill="#ffffff"/>
    </svg>`);
    ...
    const overlay=Buffer.from(`<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      <circle cx="110" cy="260" r="30" fill="#8b5cf6"/>
      <text x="110" y="271" text-anchor="middle" font-family="DejaVu Sans, sans-serif" font-size="31" font-weight="800" fill="#ffffff">A</text>
      <circle cx="670" cy="260" r="30" fill="#8b5cf6"/>
      <text x="670" y="271" text-anchor="middle" font-family="DejaVu Sans, sans-serif" font-size="31" font-weight="800" fill="#ffffff">B</text>
      <rect x="390" y="555" width="420" height="56" rx="28" fill="#8b5cf6"/>
      <text x="600" y="591" text-anchor="middle" font-family="DejaVu Sans, sans-serif" font-size="25" font-weight="800" letter-spacing="1" fill="#ffffff">VOTE ON TIEBREAK</text>
    </svg>`);
