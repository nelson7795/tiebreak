...
async function landscape(A,B,ab,bb){
  ...
  const base=Buffer.from(`<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="brand" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#8b5cf6"/><stop offset="1" stop-color="#d946ef"/></linearGradient></defs><rect width="1200" height="630" fill="#0b0d17"/><rect x="48" y="28" width="1104" height="82" rx="24" fill="#121625" stroke="#2e3550" stroke-width="2"/><rect x="66" y="48" width="10" height="42" rx="5" fill="url(#brand)"/>${vectorText('TIEBREAK',96,49,38,'#ffffff',5.8,.6)}<rect x="60" y="150" width="505" height="340" rx="24" fill="#ffffff" stroke="#2d344a" stroke-width="3"/><rect x="635" y="150" width="505" height="340" rx="24" fill="#ffffff" stroke="#2d344a" stroke-width="3"/><rect x="330" y="515" width="540" height="82" rx="41" fill="url(#brand)"/>${vectorText('VOTE NOW',455,536,38,'#ffffff',6.5,.65)}<path d="M785 556 H820 M805 541 L820 556 L805 571" fill="none" stroke="#fff" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/></svg>`);
